...
const PublishCourse = () => {
  ...
  return (
    <div className="bg-richblack-800 border border-richblack-600 rounded-lg p-4 sm:p-5">
      <div className="text-xl sm:text-2xl font-semibold mb-5 sm:mb-7">
        Publish Settings
      </div>
      <form onSubmit={handleSubmit(handlePublishCourse)}>
        <div className="flex gap-2 items-center">
          ...
          />
          <label
            className="text-richblack-200 text-base sm:text-lg"
            htmlFor="public"
          >
        ...
        <div className="flex justify-end gap-x-2 sm:gap-x-3 mt-6 sm:mt-7">
          <button
            onClick={goBack}
          ...
          <button
            className="bg-yellow-50 text-black hover:shadow-sm hover:shadow-brown-25 px-4 sm:px-5 py-2 
