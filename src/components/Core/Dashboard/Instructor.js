      ...
      {loading ? (
        ...
        <div>
          <div className="flex space-x-4">
            {totalAmount > 0 && totalStudents > 0 ? (
              ...
              <div className="text-caribbeangreen-600">Not Enough Data to Visualize</div>
            )}
        ...
        <div>
          ...
          <Link to={"/dashboard/add-course"}>
            <button
              className={` my-10 px-5 py-2 font-semibold text-center rounded-md transition-all duration-200 hover:scale-95
