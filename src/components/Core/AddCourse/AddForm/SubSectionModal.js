...
const SubSectionModal = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen 
            ...
            {!view && (
              <div className="mt-4 flex justify-center">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-richblack-600 hover:bg-richblack-500 text-richblack-5 rounded-md transition-colors duration-200"
                >
          ...
          {!view && (
            <div className="flex justify-end">
              <IconBtn
                ...
                customClasses={
                  "bg-yellow-100 text-richblack-900 font-semibold mt-5"
                }
              />
            </div>
          )}
